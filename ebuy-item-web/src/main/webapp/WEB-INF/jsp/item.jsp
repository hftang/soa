...
<head>
    <title>${item.title } - 易购商城</title>
    <script>
        var _SF_CFG = {
            www_url: 'http://www.buy.com',
            m_url: 'http://m.buy.com',
            productId:${item.id},
            number: 1600229585,
            minBuy: 1,
            maxBuy: 99,
            ...
            price: 0,
            warehouse: 0,
            homeurl: 'http://home.buy.com',
            staticurl: 'http://i.buy.com/html',
            passporturl: 'https://passport.buy.com',
            businessModel: 3,
            commentType: 0
        };
    </script>
...
<div class="linknav">
    <div class="breadcrumb"><strong><a href="/food/6-0-0-0-0-2-0-0-0-0-0.html">休闲食品</a></strong><span> &gt; <a
            ...
            href="http://www.buy.com/pinpai/7331-10863.html">我是花吃</a> &gt; 我是花吃 我是花吃鲜花月饼团圆礼盒390g</span></div>
</div>
<div class="pWrap">
    <div class="productIntro">
                            ...
                            <div class="phone_clientCode" style="display:none;">
                                ...
                                <script type="text/javascript">
                                    jQuery('#qrcodeTableBig1').qrcode({
                                        render: "table",
                                        text: "http://www.buy.com/html/products/230/1600229585.html",
                                        width: "124",
                                        height: "124"
                                    });
                                </script>
            ...
            <div class="pView">
                <div id="pView">
                    <div id="zoom-jpg" class="jqzoom">
                        <c:forTokens items="${item.image }" delims="," varStatus="status" var="image">
                            <c:if test="${status.index==0 }">
                                <img alt="" width="330" height="330" src="${image }" jqimg="${image }"/>
                            </c:if>
                        </c:forTokens>
                    </div>
                    <div id="pic-list">
                        ...
                        <div class="pic-items"
                            ...
                            <ul style="position: absolute; left: 0px; top: 0px; height: 240px;">
                                <c:forTokens items="${item.image }" delims="," var="image">
        ...
        <div class="pItemsSide">
            ...
            <div class="pdetail">
                <ul>
                    <li>品牌：<span><a href="http://www.buy.com/pinpai/7331-10863.html" title="我是花吃"
...
<div class="pWrap">
    <div class="main-box">
        ...
        <div class="pDetail">
            ...
            <div id="add-cart-r-btn-sf" class="p-btn"><a href="javascript:void(0);"
                                                         data_url="http://p02.buy.com/2016/1600229585/thumb_1600229585_1_1.jpg"
        ...
        <div class="pCont cpjs_box" id="div-detail">
            ...
            <div class="pJiucuo">
                如果您发现商品信息存在问题，<a target="_blank"
                                 href="http://www.buy.com/ProductCorrection/ProductCorrection/pId/${item.id}"
                                 rel="nofollow">欢迎纠错</a>
            </div>
                            ...
                            <div>
                                <a class="pbtn2" href="javascript:Goods.gotoPl()" rel="nofollow">马上评价</a><span
                                    class="showMore"><a target="_blank"
                                                        href="http://www.buy.com/html/article/140/133.html"
    ...
    <div class="left-box">
        <div id="brandCon" class="catlist" style="">
            ...
            <ul class="pClass">
                <li><a target="_blank"
                       href="http://www.buy.com/pinpai/7331-10949.html#sfbest_item_1600229585_brand_1"
                       title="半岛月饼">半岛月饼</a><a target="_blank"
                                               href="http://www.buy.com/pinpai/7331-3342.html#sfbest_item_1600229585_brand_2"
                                               title="元朗荣华">元朗荣华</a><a target="_blank"
                                                                       href="http://www.buy.com/pinpai/7331-2241.html#sfbest_item_1600229585_brand_3"
                                                                       title="奇华">奇华</a><a target="_blank"
                                                                                           href="http://www.buy.com/pinpai/7331-6626.html#sfbest_item_1600229585_brand_4"
                                                                                           title="迪士尼">迪士尼</a><a
                        target="_blank"
                        href="http://www.buy.com/pinpai/7331-10805.html#sfbest_item_1600229585_brand_5"
                        title="宜芝多">宜芝多</a><a target="_blank"
                                              href="http://www.buy.com/pinpai/7331-9347.html#sfbest_item_1600229585_brand_6"
                                              title="日田食品">日田食品</a><a target="_blank"
                                                                      href="http://www.buy.com/pinpai/7331-10765.html#sfbest_item_1600229585_brand_7"
                                                                      title="欧美香" style="display: none;">欧美香</a><a
                        target="_blank"
                        href="http://www.buy.com/pinpai/7331-10853.html#sfbest_item_1600229585_brand_8"
                        title="零食多" style="display: none;">零食多</a><a target="_blank"
                                                                     href="http://www.buy.com/pinpai/7331-10863.html#sfbest_item_1600229585_brand_9"
                                                                     title="我是花吃" style="display: none;">我是花吃</a><a
                        target="_blank"
                        href="http://www.buy.com/pinpai/7331-2696.html#sfbest_item_1600229585_brand_10"
                        title="史努比 Snoopy" style="display: none;">史努比 Snoopy</a><a
                        target="_blank"
                        href="http://www.buy.com/pinpai/7331-3662.html#sfbest_item_1600229585_brand_11"
                        title="郭元益" style="display: none;">郭元益</a><a target="_blank"
                                                                     href="http://www.buy.com/pinpai/7331-4986.html#sfbest_item_1600229585_brand_12"
                ...
                <ul class="l-buy" id="buyrebuy-sf">
                    <li>
                        ...
                        <div class="title-a"><a target="_blank"
                                                href="http://www.buy.com/html/products/5/1800005691.html#trackref=sfbest_item_1600229585_buy1_1">归原Green
                ...
                <ul class="l-buy" id="browserbrowse-sf">
                    <li>
                        <div class="p-img"><a target="_blank" href="#"><img
                                src="/images/small_1800005691_1_1_1.jpg"></a></div>
                        <div class="title-a"><a target="_blank"
                                                href="http://www.buy.com/html/products/5/1800005691.html#trackref=sfbest_item_1600229585_see_1">归原Green
                            Yard 有机鲜牛奶 486ml</a></div>
                        <div class="title-b">【下单后3-5天发货】外包装更换中，请以实物为准</div>
                        <div class="p-price">￥20</div>
                    </li>
