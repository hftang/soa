...
<div id="header">
  <div class="header_inner">
    ...
    <div class="search"> <%-- http://localhost:5085/search.html--%>
      <form action="http://search.ebuy.com/search.html" id="searchForm" name="query" method="GET">
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="http://localhost:5089/cart/cart.html" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
